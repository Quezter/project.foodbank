...
return [
    ...
    */
    ...
    "about_body_two_one" => "The Amsterdam Food Bank is a non-profit organization that relies solely on donations to feed 20 000 people across the city of Amsterdam and North-Holland. With a lack of financial and fresh produce support, the FoodBank Project aims to provide support in these areas through creating and providing long-term sustainable solutions.",
    "about_body_two_two" => "Beyond volunteer recruitment based support, the FoodBank Project uses student resources, pooled knowledge from different student backgrounds, to assess and measure key performance areas in order to identify and rectify potential improvement areas within the Amsterdam Food Bank.",
    "about_body_two_highlight" => "We provide the support where no support is given."
];
